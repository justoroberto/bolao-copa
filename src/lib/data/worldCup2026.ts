...
export const WORLD_CUP_MATCHES: Match[] = [
  ...
  // Grupo B — 12 Jun
  { id: 'match_B1', group: 'Grupo B', homeTeam: '🇨🇦 Canadá', awayTeam: '🇧🇦 Bósnia', startTime: new Date('2026-06-12T20:00:00Z'), stage: 'group', status: 'scheduled' },
  ...
  { id: 'match_C2', group: 'Grupo C', homeTeam: '🇭🇹 Haiti', awayTeam: '🏴󠁧󠁢󠁳󠁣󠁴󠁿 Escócia', startTime: new Date('2026-06-13T18:00:00Z'), stage: 'group', status: 'scheduled' },
  ...
  // Grupo K — 17 Jun
  { id: 'match_K1', group: 'Grupo K', homeTeam: '🇵🇹 Portugal', awayTeam: '🇨🇩 RD Congo', startTime: new Date('2026-06-17T20:00:00Z'), stage: 'group', status: 'scheduled' },
  ...
  // Grupo L — 17 Jun
  { id: 'match_L1', group: 'Grupo L', homeTeam: '🏴󠁧󠁢󠁥󠁮󠁧󠁿 Inglaterra', awayTeam: '🇭🇷 Croácia', startTime: new Date('2026-06-18T00:00:00Z'), stage: 'group', status: 'scheduled' },
  ...
  // Grupo B — 19 Jun
  { id: 'match_B3', group: 'Grupo B', homeTeam: '🇶🇦 Catar', awayTeam: '🇧🇦 Bósnia', startTime: new Date('2026-06-19T20:00:00Z'), stage: 'group', status: 'scheduled' },
  ...
  { id: 'match_C4', group: 'Grupo C', homeTeam: '🏴󠁧󠁢󠁳󠁣󠁴󠁿 Escócia', awayTeam: '🇲🇦 Marrocos', startTime: new Date('2026-06-20T01:00:00Z'), stage: 'group', status: 'scheduled' },
  ...
  { id: 'match_K4', group: 'Grupo K', homeTeam: '🇨🇩 RD Congo', awayTeam: '🇺🇿 Uzbequistão', startTime: new Date('2026-06-23T23:00:00Z'), stage: 'group', status: 'scheduled' },

  // Grupo L — 23 Jun
  { id: 'match_L3', group: 'Grupo L', homeTeam: '🏴󠁧󠁢󠁥󠁮󠁧󠁿 Inglaterra', awayTeam: '🇬🇭 Gana', startTime: new Date('2026-06-24T00:00:00Z'), stage: 'group', status: 'scheduled' },
  ...
  { id: 'match_B6', group: 'Grupo B', homeTeam: '🇧🇦 Bósnia', awayTeam: '🇨🇭 Suíça', startTime: new Date('2026-06-25T20:00:00Z'), stage: 'group', status: 'scheduled' },
  ...
  { id: 'match_K6', group: 'Grupo K', homeTeam: '🇨🇩 RD Congo', awayTeam: '🇨🇴 Colômbia', startTime: new Date('2026-06-27T23:00:00Z'), stage: 'group', status: 'scheduled' },
  ...
  { id: 'match_L6', group: 'Grupo L', homeTeam: '🇵🇦 Panamá', awayTeam: '🏴󠁧󠁢󠁥󠁮󠁧󠁿 Inglaterra', startTime: new Date('2026-06-28T02:00:00Z'), stage: 'group', status: 'scheduled' },
